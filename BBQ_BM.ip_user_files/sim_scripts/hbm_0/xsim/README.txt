...
#
# Generated by export_simulation on Sun Jul 27 20:32:10 CST 2025
#
################################################################################
...
'-reset_run' switch to the './hbm_0.sh' script.
...
./hbm_0.sh -noclean_files

For more information on the script, please type './hbm_0.sh -help'.
